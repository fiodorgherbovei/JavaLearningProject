...
public class GitWorkFlow {
    public static void main (String[] args)
    {
        ...
        String step3 = "Perform git fetch command - to fetch the origin branch";
        ...
        String step7 = "Execute git commit by using the IntelliJ interface, where you can select what changes you wand to commit";
        String step8 = "Once all the the chances, are committed, execute a git push command by using CTRL+ALT+K hot keys";
        ...
        String step14 = "In case of a commit amend then the last commit will be adjusted by using git commit amend";
        String step15 = "After that, the origin/master contains the latest changes and the origin/new_branch_name can be deleted";
        String step16 = "Do not forget that locally you are still on the new_branch_name, it's got to move back to master";
